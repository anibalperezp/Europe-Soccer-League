...
public class BBVAfechad4Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detalles_sf4);
		inten=new Intent(this, BBVAfechaj2Activity.class);
		TextView encabezado=(TextView)findViewById(R.id.rests4);
		TextView g=(TextView)findViewById(R.id.dgs4);
		TextView ta=(TextView)findViewById(R.id.das4);
		TextView tr=(TextView)findViewById(R.id.drs4);
		TextView l=(TextView)findViewById(R.id.dlss4);
