...
public class BBVAfechad6Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detalles_sf6);
		inten=new Intent(this, BBVAfechaj2Activity.class);
		TextView encabezado=(TextView)findViewById(R.id.rests6);
		TextView g=(TextView)findViewById(R.id.dgs6);
		TextView ta=(TextView)findViewById(R.id.das6);
		TextView tr=(TextView)findViewById(R.id.drs6);
		TextView l=(TextView)findViewById(R.id.dlss6);
