...
public class Premierfechad38Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detalles_ef38);
		inten=new Intent(this, BBVAfechaj4Activity.class);
		TextView encabezado=(TextView)findViewById(R.id.reste38);
		TextView g=(TextView)findViewById(R.id.dge38);
		TextView ta=(TextView)findViewById(R.id.dae38);
		TextView tr=(TextView)findViewById(R.id.dre38);
		TextView l=(TextView)findViewById(R.id.dlse38);
