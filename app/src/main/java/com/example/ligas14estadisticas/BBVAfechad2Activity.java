...
public class BBVAfechad2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detalles_sf2);
		inten=new Intent(this, BBVAfechaj2Activity.class);
		TextView encabezado=(TextView)findViewById(R.id.rests2);
		TextView g=(TextView)findViewById(R.id.dgs2);
		TextView ta=(TextView)findViewById(R.id.das2);
		TextView tr=(TextView)findViewById(R.id.drs2);
		TextView l=(TextView)findViewById(R.id.dlss2);
