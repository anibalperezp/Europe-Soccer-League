...
public class BBVAfechaj23Activity  extends Activity {
	...
	{ 
        ...
        setContentView(R.layout.noticiaale);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        TextView v1=(TextView)findViewById(R.id.sal1);
		TextView v2=(TextView)findViewById(R.id.sal2);
		TextView v3=(TextView)findViewById(R.id.sal3);
		TextView v4=(TextView)findViewById(R.id.sal4);
		TextView v5=(TextView)findViewById(R.id.sal5);
		TextView v6=(TextView)findViewById(R.id.sal6);
		TextView v7=(TextView)findViewById(R.id.sal7);
		TextView v8=(TextView)findViewById(R.id.sal8);
		TextView v9=(TextView)findViewById(R.id.sal9);
		TextView v10=(TextView)findViewById(R.id.sal10);
		
		TextView f1=(TextView)findViewById(R.id.fechasal1);
		TextView f2=(TextView)findViewById(R.id.fechasal2);
		TextView f3=(TextView)findViewById(R.id.fechasal3);
		TextView f4=(TextView)findViewById(R.id.fechasal4);
		TextView f5=(TextView)findViewById(R.id.fechasal5);
		TextView f6=(TextView)findViewById(R.id.fechasal6);
		TextView f7=(TextView)findViewById(R.id.fechasal7);
		TextView f8=(TextView)findViewById(R.id.fechasal8);
		TextView f9=(TextView)findViewById(R.id.fechasal9);
		TextView f10=(TextView)findViewById(R.id.fechasal10);
		
		final Button b1=(Button)findViewById(R.id.btnspja1);
		final Button b2=(Button)findViewById(R.id.btnspja2);
		final Button b3=(Button)findViewById(R.id.btnspja3);
		final Button b4=(Button)findViewById(R.id.btnspja4);
		final Button b5=(Button)findViewById(R.id.btnspja5);
		final Button b6=(Button)findViewById(R.id.btnspja6);
		final Button b7=(Button)findViewById(R.id.btnspja7);
		final Button b8=(Button)findViewById(R.id.btnspja8);
		final Button b9=(Button)findViewById(R.id.btnspja9);
		final Button b10=(Button)findViewById(R.id.btnspja10);
		...
		final Button bimg1=(Button)findViewById(R.id.buttonsal1);
		final Button bimg2=(Button)findViewById(R.id.buttonsal2);
		final Button bimg3=(Button)findViewById(R.id.buttonsal3);
		final Button bimg4=(Button)findViewById(R.id.buttonsal4);
		final Button bimg5=(Button)findViewById(R.id.buttonsal5);
		final Button bimg6=(Button)findViewById(R.id.buttonsal6);
		final Button bimg7=(Button)findViewById(R.id.buttonsal7);
		final Button bimg8=(Button)findViewById(R.id.buttonsal8);
		final Button bimg9=(Button)findViewById(R.id.buttonsal9);
		final Button bimg10=(Button)findViewById(R.id.buttonsal10);
		 ...
		 b1.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View arg0) 
				{
					...
					Intent myIntent =new Intent(arg0.getContext(), Premierfechaj18Activity.class);
		 ...
		 b2.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View arg0) 
				{
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj11Activity.class);
					startActivityForResult(myIntent, 0);
			...
			b3.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj12Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b4.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj13Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b5.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj14Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b6.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj15Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b7.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj16Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b8.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj17Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b9.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Bundfechaj18Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b10.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Premierfechaj17Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
