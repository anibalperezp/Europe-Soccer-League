...
public class Calciofechad28Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detalles_if28);
		inten=new Intent(this, BBVAfechaj3Activity.class);
		TextView encabezado=(TextView)findViewById(R.id.resti28);
		TextView g=(TextView)findViewById(R.id.dgi28);
		TextView ta=(TextView)findViewById(R.id.dai28);
		TextView tr=(TextView)findViewById(R.id.dri28);
		TextView l=(TextView)findViewById(R.id.dlsi28);
