...
public class CalcioHistoriaTablaActivity extends Activity {
	...
	{ 
        ...
        setContentView(R.layout.noticiaita);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        TextView v1=(TextView)findViewById(R.id.sit1);
		TextView v2=(TextView)findViewById(R.id.sit2);
		TextView v3=(TextView)findViewById(R.id.sit3);
		TextView v4=(TextView)findViewById(R.id.sit4);
		TextView v5=(TextView)findViewById(R.id.sit5);
		TextView v6=(TextView)findViewById(R.id.sit6);
		TextView v7=(TextView)findViewById(R.id.sit7);
		TextView v8=(TextView)findViewById(R.id.sit8);
		TextView v9=(TextView)findViewById(R.id.sit9);
		TextView v10=(TextView)findViewById(R.id.sit10);
		
		TextView f1=(TextView)findViewById(R.id.fechasit1);
		TextView f2=(TextView)findViewById(R.id.fechasit2);
		TextView f3=(TextView)findViewById(R.id.fechasit3);
		TextView f4=(TextView)findViewById(R.id.fechasit4);
		TextView f5=(TextView)findViewById(R.id.fechasit5);
		TextView f6=(TextView)findViewById(R.id.fechasit6);
		TextView f7=(TextView)findViewById(R.id.fechasit7);
		TextView f8=(TextView)findViewById(R.id.fechasit8);
		TextView f9=(TextView)findViewById(R.id.fechasit9);
		TextView f10=(TextView)findViewById(R.id.fechasit10);
		
		final Button b1=(Button)findViewById(R.id.btnspji1);
		final Button b2=(Button)findViewById(R.id.btnspji2);
		final Button b3=(Button)findViewById(R.id.btnspji3);
		final Button b4=(Button)findViewById(R.id.btnspji4);
		final Button b5=(Button)findViewById(R.id.btnspji5);
		final Button b6=(Button)findViewById(R.id.btnspji6);
		final Button b7=(Button)findViewById(R.id.btnspji7);
		final Button b8=(Button)findViewById(R.id.btnspji8);
		final Button b9=(Button)findViewById(R.id.btnspji9);
		final Button b10=(Button)findViewById(R.id.btnspji10);
		...
		final Button bimg1=(Button)findViewById(R.id.buttonsit1);
		final Button bimg2=(Button)findViewById(R.id.buttonsit2);
		final Button bimg3=(Button)findViewById(R.id.buttonsit3);
		final Button bimg4=(Button)findViewById(R.id.buttonsit4);
		final Button bimg5=(Button)findViewById(R.id.buttonsit5);
		final Button bimg6=(Button)findViewById(R.id.buttonsit6);
		final Button bimg7=(Button)findViewById(R.id.buttonsit7);
		final Button bimg8=(Button)findViewById(R.id.buttonsit8);
		final Button bimg9=(Button)findViewById(R.id.buttonsit9);
		final Button bimg10=(Button)findViewById(R.id.buttonsit10);
		 ...
		 b1.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View arg0) 
				{
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj14Activity.class);
		 ...
		 b2.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View arg0) 
				{
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj15Activity.class);
					startActivityForResult(myIntent, 0);
			...
			b3.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj16Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b4.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj17Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b5.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj18Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b6.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj19Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b7.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj20Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b8.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj21Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b9.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj22Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			...
			b10.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent myIntent =new Intent(arg0.getContext(), Calciofechaj13Activity.class);
					startActivityForResult(myIntent, 0);
				}
			});
